...
foreach ($blockedTags as $tag) {
    $name = preg_replace('/<' . preg_quote($tag, '/') . '\b[^>]*>/i', '[FILTERED]', $name);
}
...
<head>
    <meta charset="UTF-8">
    <title>XSS Challenge - Hard</title>
    <style>
...
<body>
    ...
    <h1>XSS Challenge - Hard</h1>
    <p>I don't think you can bypass this one...</p>
